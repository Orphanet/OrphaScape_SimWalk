...
- [#Step-by-step usage](#step-by-step-usage)
	...
	- [#Step 2 - Build the Disease-Disease (DD) similarity matrix  (modif Maroua)](#step-2---build-the-disease-disease-(dd)-similarity-matrix--(modif-maroua)
	- [#Weight Vector Explanation](#weight-vector-explanation)
	- [#Step 3 - Build the Disease-Patient (DP) similarity vectors (modif Maroua)](#step-3---build-the-disease-patient-(dp)-similarity-vectors-(modif-maroua)
	- [#Steps 4 & 5 - Patient integration and Random Walk with Restart (modif Maroua)](#steps-4-&-5---patient-integration-and-random-walk-with-restart-(modif-maroua)
	- [#Step 6 - Results (modif Maroua)(#step-6---results-(modif-maroua)
- [#Computational considerations](#computational-considerations)
- [#Example workflow (subset of 10 diseases) (modif Maroua)](#example-workflow-(subset-of-10-diseases)-(modif-maroua)
